...
export const SliderData = [
  {
      ...
      desc: "Unlock Exclusive Savings! Enjoy a generous 50% off your first shopping spree with us. ",
      cover: sofaSlide,
  },
  {
      id: 2,
      title: "50% Off For Your First Shopping",
      desc: "Don't miss out – shop now and redefine your shopping experience with unparalleled discounts!",
      cover: phone08,
  },
  {
      id: 3,
      title: "50% Off For Your First Shopping",
      desc: "Dive into a world of irresistible deals on electronics, furniture, and fashion. Elevate your style and save big. ",
      cover: wireless01,
  },
  {
      id: 4,
      title: "50% Off For Your First Shopping",
      desc: "Your gateway to affordability starts with a fabulous 50% off on your inaugural purchase!",
      cover: watchSlide,
  },
];
...
export const serviceData = [
  {
    ...
    title: "Free Shipping",
    subtitle: "Swift delivery at no extra cost.",
    bg: "#fdefe6",
  },
  {
    icon: <ion-icon name="card"></ion-icon>,
    title: "Safe Payment",
    subtitle: "Secure your purchases with confidence.",
    bg: "#ceebe9",
  },
  {
    icon: <ion-icon name="shield-half-outline"></ion-icon>,
    title: "Secure Payment",
    subtitle: "Safeguard transactions for worry-free shopping.",
    bg: "#e2f2b2",
  },
  {
    icon: <ion-icon name="headset"></ion-icon>,
    title: " Back Guarantee",
    subtitle: "Shop risk-free with our money-back guarantee.",
    bg: "#d6e5fb",
  },
];
